...
public class TableFormPage extends AbstractPageObject {
    ...
    @Step("Fill Registration form with [{0},{1}, {2}, {3}, {4}, {5}]")
    public TableFormPage fillInRegistrationForm(String firstName, String lastName, String email, String age, String salary, String department) {
    ...
    @Step("Modify the Department with [{0}]")
    public TableFormPage editRegistrationForm(String departmentModified) {
        adsScrollHandler(uploadAndDownload);
    ...
    @Step("Delete the added modified record")
    public TableFormPage deleteRegistrationForm() {
